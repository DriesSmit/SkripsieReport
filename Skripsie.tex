...
\promotor{STUDY LEADER: Prof. J.A. du Preez}
...
%\include{ECSAOutcomes/ECSAOutcomes}

\addcontentsline{toc}{chapter}{Abstract}
\include{Abstract/abstract}
\addcontentsline{toc}{chapter}{Uittreksel}
\include{Abstract/uittreksel}
...
\include{Chapter2/chapter2}			%Literature study
\include{Chapter3/chapter3}			%Image processing
\include{Chapter4/chapter4}			%Machine learning approach
\include{Chapter5/chapter5}			%Results
%\include{Chapter6/chapter6}
%\include{Chapter7/chapter7}

\include{Conclusions/conclusions}	%Conclusion
...
\appendix
\include{Appendix1/appendix1} %Graphical overview of system
\include{Appendix2/appendix2} %Mathematical derivation of whole system
\include{Appendix3/appendix3} %Implementation/Algorithms
\include{Appendix4/appendix4} %Results and validation
\include{Appendix5/appendix5} %ProjectPlan


%\include{Appendix7/appendix7} %Experiments

%\include{Appendix3/appendix3} %DelynoMinutes
%\include{Appendix4/appendix4} %BekkerMinutes
